...
//        props.put("acks", "all");
        ...
        Map<String, Object> parse = def.parse(props); // 不会添加进去 因为 他的参数是固定的……
        Map<String, ConfigKey> stringConfigKeyMap = def.configKeys();
        System.out.println(stringConfigKeyMap.size());
    }
    /**
    ...
    public static class ConfigKey {
        ...
        public final String documentation; // 注释
        public final Object defaultValue; // 默认value
        public final Validator validator; // 验证器
        public final Importance importance; // 重要性 3档
        public final String group; // 分组
        public final int orderInGroup; // 排名
        public final Width width; // 宽度
        public final String displayName; // 显示名称
        public final List<String> dependents; // 依赖
