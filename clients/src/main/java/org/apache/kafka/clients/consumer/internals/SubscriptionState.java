 ...
 */
public class SubscriptionState { // 追踪定位topicPartition 与offset 之间对应的关系
    ...
    /* the pattern user has requested 正则表达式集*/
    private Pattern subscribedPattern;

    /* the list of topics the user has requested 记录所订阅的 topic*/
    ...
    /* the list of partitions currently assigned */  // TopicPartitionState 保存了offset的状态 任何模式 都会记录
     ...
     */
    private void setSubscriptionType(SubscriptionType type) { // AUTO_TOPICS, AUTO_PATTERN, USER_ASSIGNED 互斥
    ...
    private static class TopicPartitionState {
        ...
        // 枚举类型 重置position的策略 同时 resetStrategy 是否 null 也表示了 是否需要重置position
